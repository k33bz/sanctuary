...
execute if score @s timber_c_axe matches 1.. if score durability timber matches 190.. run item replace entity @s weapon.mainhand with minecraft:air
execute if score @s timber_c_axe matches 1.. if score durability timber matches 190.. run playsound minecraft:entity.item.break player @a ~ ~ ~
